...
url1_espn <- paste("http://games.espn.go.com/ffl/tools/projections?slotCategoryId=4&scoringPeriodId=", week, "&seasonId=2014", sep="")
url2_espn <- paste("http://games.espn.go.com/ffl/tools/projections?slotCategoryId=4&scoringPeriodId=", week, "&seasonId=2014&startIndex=40", sep="")
url3_espn <- paste("http://games.espn.go.com/ffl/tools/projections?slotCategoryId=4&scoringPeriodId=", week, "&seasonId=2014&startIndex=80", sep="")
url4_espn <- paste("http://games.espn.go.com/ffl/tools/projections?slotCategoryId=4&scoringPeriodId=", week, "&seasonId=2014&startIndex=120", sep="")
url_pickingpros <- paste("http://pickingpros.com/nfl/", week, "-wide-receiver-projections.php", sep="")

#updated on wednesdays
url_fftoday1 <- paste("http://www.fftoday.com/rankings/playerwkproj.php?Season=2014&GameWeek=", week, "&PosID=30", sep="")
url_fftoday2 <- paste("http://www.fftoday.com/rankings/playerwkproj.php?Season=2014&GameWeek=", week, "&PosID=30&LeagueID=1&order_by=FFPts&sort_order=DESC&cur_page=1", sep="")
url_ffs <- "http://www.fantasysharks.com/apps/Projections/WeeklyWRProjections.php" #this is from last year
...
#trim the data
je_wrproj <- je_wrproj[2:(dim(je_wrproj)[1]-1),]
dr_wrproj <- dr_wrproj[2:(dim(dr_wrproj)[1]-1),]
...
import_fftoday_wrproj1 <- import_fftoday_wrproj1[2:(dim(import_fftoday_wrproj1)[1]),]
import_fftoday_wrproj2 <- import_fftoday_wrproj2[2:(dim(import_fftoday_wrproj2)[1]),]
...
espn_wrproj$name[espn_wrproj$name=="Odell Beckham Jr."] <- "Odell Beckham"
fftoday_wrproj$name[fftoday_wrproj$name=="Odell Beckham Jr."] <- "Odell Beckham"
...
projections <- merge(je_wrproj, dr_wrproj, by="name")
...
fantasyproj <- subset(projections, select = c("name","espn_fpts", "je_fpts", "fft_fpts", "dr_fpts", "pp_fpts"))
...
reddit.summary.filename <- paste("week", week, "wr_uncertainty_reddit_summary2014.html", sep="")

#detailed table
reddit.detailed <- fantasyproj
reddit.detailed.fpts <- subset(reddit.detailed, select = c("name","espn_fpts", "je_fpts", "fft_fpts", "dr_fpts", "pp_fpts"))
...
reddit.detailed.filename <- paste("week", week, "wr_uncertainty_reddit_detailed2014.html", sep="")
...
#print.xtable(htmltable_fantasyproj, type="html", file="2014week1wrrisk.html", include.rownames=FALSE)
#print.xtable(htmltable_projections, type="html", file="2014week1wrprojections.html", include.rownames=FALSE)
